<template>
    <teleport to="body">
        <div class=" minimo fixed z-10 overflow-y-auto inset-0  bg-black bg-opacity-50 ">
            <div ref="especificDiv" @click="handleClickInside"
                ...
                <img class="mx-auto mb-3 mt-1 w-11/12 object-contain border-2 rounded-lg" :src="link" alt="Monster Photo"
                    :key="link" />
            </div>
        </div>
    </teleport>
